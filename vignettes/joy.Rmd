...
`multimedia` is a package for **Multi**-omics **Media**tion analysis. This
vignette gives a brief introduction using simulated that look vaguely like
BeWell. The basic question is -- we know that meditation can reduce depression
and anxiety symptoms, so is it possible that microbiome shifts might play a
role? In the language of mediation analysis, does the microbiome mediate PHQ
score?
...
We can look at the estimated mediation and outcome models.
