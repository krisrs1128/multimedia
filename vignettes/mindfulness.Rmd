...
if (is.null(cmdstan_version(error_on_NA = FALSE))) {
    message("Oh no! This vignette depends on having a version of cmdstanr 
            available locally. This is because the LNM model is implemented with 
            a cmdstan script. Please try setting this up using 
            `install_cmdstanr()`! We'll skip the remaining code blocks until 
            this is ready.")
